// File: app/artists/footerOfTheDrawer.tsx
...
export default function FooterOfTheDrawer({ selectedVideo, playing, shuffle, repeatMode, volume, oldVolume, handleShuffleClick, handleSkipBack, handleSkipForward, handleRepeatClick, handleVolumeChange, setPlaying, played, onSeek }) {
