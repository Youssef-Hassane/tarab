...
export default function FooterSection({ inDrawer = false }) {
    ...
    return (
        <div className={`${inDrawer
                ...
                : `bg-custom-dark text-base-content rounded h-[70px] w-screen fixed bottom-0 left-0 z-50 ${isDesktop ? '' : 'bg-custom-dark text-base-content rounded h-[65px] fixed bottom-[60px] w-[calc(100%-10px)] mx-[5px] border-red-500 border-2 border-opacity-50'}`
            } 
